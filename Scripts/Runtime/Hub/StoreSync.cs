...
public sealed class StoreSync
{
    ...
    private readonly    Dictionary<long, EntityChange>  entityChanges;
    ...
    public StoreSync (EntityStore store, StoreClient client) {
        ...
        entityChanges   = new Dictionary<long, EntityChange>();
    ...
    public List<string> LoadEntities()
    {
        ...
        client.SyncTasksSynchronous(); // todo enable synchronous queries in MemoryDatabase
    ...
    public void UpsertDataEntity(long pid)
    {
        entityChanges[pid] = EntityChange.Upsert;
    }
    
    public void DeleteDataEntity(long pid)
    {
        entityChanges[pid] = EntityChange.Delete;
    }
